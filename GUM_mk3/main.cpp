...
int main(void) {
	...
	int shape[3] = { 8,8,16 };//{ 8,8,16 };//{ 20,20,40 }; //{ 14,14,18 }; //{ 2,2,4 };//{ 4,4,8 };
	int species[3] = {512,512,0};// { 512, 384, 128 };//{ 8000,8000,0 };  //{ 2744,2744,0 }; //{8,6,2};//{ 64,48,16 };
	...
	runMetropolis(1, 10, 11, .005, atom_list, cluster_rules, spin_rules);
	int exit;
	std::cin >> exit;
}