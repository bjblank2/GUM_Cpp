...
int main(void) {
	...
	int shape[3] = { 20,20,40 };//{ 20,20,40 }; //{ 14,14,18 }; //{ 2,2,4 };//{ 4,4,8 };
	int species[3] = { 8000,4000,4000 };//{ 8000,8000,0 }; //{ 2744,2744,0 }; //{8,6,2};//{ 64,48,16 };
	...
	runMetropolis(1000, 300, 10000, 5, atom_list, cluster_rules, spin_rules);
	int exit;
	std::cin >> exit;
}